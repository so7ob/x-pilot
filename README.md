...
2. عرض أسماء مساحات العمل عند تبديلها الأخير داخل مجموعة «الأحدث استخدامًا» في لوحة الأوامر.
3. قرار منتج مفتوح: نص الشارة يعرض عدد عناصر قائمة الانتظار المتبقية بعد التصفية (بدل الإجمالي) — يحتاج موافقة قبل التنفيذ.
